...
const DEFAULT_DEPT_REQ_DATA = [{ name: "勞作", grade: 1, days: [1], periods: ['5'], sem: 3 }, { name: "勞作", grade: 1, days: [2], periods: ['5'], sem: 3 }, { name: "勞作", grade: 1, days: [3], periods: ['5'], sem: 3 }, { name: "勞作", grade: 1, days: [4], periods: ['5'], sem: 3 }, { name: "勞作", grade: 1, days: [5], periods: ['5'], sem: 3 }, { name: "英文", grade: 1, days: [1,3], periods: ['3','4'], sem: 3 }, { name: "英文", grade: 2, days: [5], periods: ['1','2'], sem: 2 }, { name: "國文", grade: 1, days: [5], periods: ['8','9'], sem: 3 }, { name: "體育", grade: 1, days: [3], periods: ['1','2'], sem: 3 }, { name: "體育", grade: 2, days: [4], periods: ['5','6'], sem: 3 }];
function getDeptReqData() { return JSON.parse(localStorage.getItem('deptReqData')) || DEFAULT_DEPT_REQ_DATA; }
